...
quantic now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<quantic_address\> \<monthly_payment_quantic\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ quantic, _12_ times over the course of a year totaling _24000_ quantic.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<quantic_address\> \<monthly_payment_quantic\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` quantic.
 ...
 * vote-many          - Vote on a quantic initiative
 * vote-alias         - Vote on a quantic initiative
 * vote               - Vote on a quantic initiative/budget

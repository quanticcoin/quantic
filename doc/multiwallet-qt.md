...
In order to support loading of multiple wallets in quantic-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is quantic.cpp.
...
Changes to quantic.cpp
----------------------
quantic.cpp is the entry point into quantic-qt, and as such, will require some minor modifications to provide hooks for

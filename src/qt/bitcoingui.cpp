                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("quantic") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a quantic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quantic: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About quantic"), this);
    aboutAction->setStatusTip(tr("Show information about quantic"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for quantic"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your quantic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified quantic addresses"));
    ...
    openAction->setStatusTip(tr("Open a quantic: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the quantic help message to get a list with possible quantic command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("quantic client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to quantic network", "", count));
}
...
{
    QString strTitle = tr("quantic"); // default title

...
/** Utility functions used by the quantic Qt UI.
 */
namespace GUIUtil
{
...
// Render quantic addresses in monospace font
...
// Parse "quantic:" URI into recipient object, return true on successful parsing

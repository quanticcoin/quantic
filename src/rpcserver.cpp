...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "quantic server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* quantic features */
        {"quantic", "masternode", &masternode, true, true, false},
        {"quantic", "listmasternodes", &listmasternodes, true, true, false},
        {"quantic", "getmasternodecount", &getmasternodecount, true, true, false},
        {"quantic", "masternodeconnect", &masternodeconnect, true, true, false},
        {"quantic", "masternodecurrent", &masternodecurrent, true, true, false},
        {"quantic", "masternodedebug", &masternodedebug, true, true, false},
        {"quantic", "startmasternode", &startmasternode, true, true, false},
        {"quantic", "createmasternodekey", &createmasternodekey, true, true, false},
        {"quantic", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"quantic", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"quantic", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"quantic", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"quantic", "getmasternodescores", &getmasternodescores, true, true, false},
        {"quantic", "mnbudget", &mnbudget, true, true, false},
        {"quantic", "preparebudget", &preparebudget, true, true, false},
        {"quantic", "submitbudget", &submitbudget, true, true, false},
        {"quantic", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"quantic", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"quantic", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"quantic", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"quantic", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"quantic", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"quantic", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"quantic", "checkbudgets", &checkbudgets, true, true, false},
        {"quantic", "mnsync", &mnsync, true, true, false},
        {"quantic", "spork", &spork, true, true, false},
        {"quantic", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"quantic", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use quanticd, or the -server option to quantic-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> quantic-cli " + methodname + " " + args + "\n";
}

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("quantic quantic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quantic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quantic transaction") + "\n" +
                               "  quantic-tx [options] -create [commands]   " + _("Create hex-encoded quantic transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quantic transaction

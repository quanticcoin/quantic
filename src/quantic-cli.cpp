...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("quantic RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  quantic-cli [options] <command> [params]  " + _("Send command to quantic") + "\n" +
                        "  quantic-cli [options] help                " + _("List commands") + "\n" +
                        "  quantic-cli [options] help <command>      " + _("Get help for a command") + "\n";

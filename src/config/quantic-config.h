/* src/config/quantic-config.h.  Generated from quantic-config.h.in by configure.  */
/* src/config/quantic-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef quantic_CONFIG_H

#define quantic_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.quantic.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "quantic Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "quantic Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "quantic"

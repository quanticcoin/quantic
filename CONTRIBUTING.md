Contributing to quantic
============================

The quantic project operates an open contributor model where anyone is
...
The following applies to code changes to the quantic project, and is not to be
confused with overall quantic Network Protocol consensus changes.

Whether a pull request is merged into quantic rests with the project merge
...
Patches that change quantic consensus rules are considerably more involved than
...
Where a patch set proposes to change the quantic consensus, it must have been
...
The project leader is the release manager for each quantic release.

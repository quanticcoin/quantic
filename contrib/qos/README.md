...
This means one can have an always-on quanticd instance running, and another local quanticd/quantic-qt instance which connects to this node and receives blocks from it.

...
RESOURCES += src/qt/quantic.qrc src/qt/quantic_locale.qrc

TRANSLATIONS += src/qt/locale/quantic_bg.ts \
                src/qt/locale/quantic_de.ts \
                src/qt/locale/quantic_en.ts \
                src/qt/locale/quantic_es.ts \
                src/qt/locale/quantic_fi.ts \
                src/qt/locale/quantic_fr.ts \
                src/qt/locale/quantic_it.ts \
                src/qt/locale/quantic_ja.ts \
                src/qt/locale/quantic_pl.ts \
                src/qt/locale/quantic_pt.ts \
                src/qt/locale/quantic_ru.ts \
                src/qt/locale/quantic_sk.ts \
                src/qt/locale/quantic_sv.ts \
                src/qt/locale/quantic_vi.ts \
                src/qt/locale/quantic_zh_CN.ts \
                src/qt/locale/quantic_zh_TW.ts
